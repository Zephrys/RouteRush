...
#rome_2_rio = ['IWnbSA2f', '670LizCP','PvXZgbor','MDWzbA6C']
rome_2_rio = ['IWnbSA2f', 'OWc7xKDw', 'V5kk7UDc', 'cDyz9FBH','xSnLwRF8','uNgEG4If' ,'PvXZgbor','MDWzbA6C']
def rio_key():
	return random.choice(rome_2_rio)
